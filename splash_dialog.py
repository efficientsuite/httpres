...
# Custom page to open links externally
...
def open_splash_screen():
    ...
    banner_pixmap = banner_pixmap.scaled(1024, 128, Qt.KeepAspectRatioByExpanding, Qt.SmoothTransformation)
    ...
    browse_button.setIcon(dialog.style().standardIcon(QStyle.SP_DirOpenIcon))
    ...
    new_collection_button.setIcon(dialog.style().standardIcon(QStyle.SP_FileIcon))
    ...
    button_box.button(QDialogButtonBox.Ok).setMinimumWidth(100)
    button_box.button(QDialogButtonBox.Cancel).setMinimumWidth(100)
    ...
    web_view.load(QUrl("https://httpres.com/news.html?theme=" + QApplication.instance().settings.get('theme', 'Dark')))
